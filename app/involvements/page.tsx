...
export default function Involvements() {
    return (
        ...
        <div className="mx-[10vw] my-4 flex flex-col bg-[#2c292f] rounded-3xl border-2 border-purple-200">
            <section>
                <h1 className="rounded-xl border-dashed border-front border-[#493562] border-4 p-2 text-5xl text-center mx-16 my-6 font-semibold">Involvments</h1>
            </section>
            <div className="flex flex-row mx-12">
                <div className="">
                    <section className="text-4xl text-center p-2 mx-4 my-2 bg-[#332447] rounded-3xl">
                        <h1 className="mx-4 my-2 font-semibold text-centered">
                            Involvements{" "}   
                        </h1>
                    ...
                    <section className="mx-6 my-4 text-xl text-center">
